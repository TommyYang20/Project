    ...
    public static void main(String[] args) {
    	...
    	try {
            ...
            connection = DriverManager.getConnection(
                                                     "jdbc:postgresql://cse180-db.lt.ucsc.edu/zyang100",
                                                     "zyang100",
                                                     "@password");
            ...
            System.out.println(app.getShowingsCount("B"));  
            System.out.println(app.updateMovieName(101, "Avatar 1"));
            System.out.println(app.updateMovieName(888, "Star Wars: A New Hope"));

            System.out.println(app.reduceSomeTicketPrices(15));
            System.out.println(app.reduceSomeTicketPrices(99));

...
# --- 7. Configure Auto-Restart for Critical Services ---
...
# --- 9. Windows Update (Applies to all systems) ---
...
# --- 10. Enable & Start Critical Services ---
Write-Host "[+] Starting scored critical services if present..."
$servicesToStart = @("DNS", "NTDS", "MSExchangeIS", "LanmanServer")
...
# --- 11. Disable Risky Services (Optional) ---
